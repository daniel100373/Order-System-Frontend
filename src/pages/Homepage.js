...
const Homepage = () => {
  ...
  let data = [
    { index: "01", name: "牛肉麵", price: 5 },
    { index: "02", name: "小籠包", price: 3 },
    { index: "03", name: "滷肉飯", price: 6 },
    { index: "04", name: "蚵仔麵線", price: 4 },
    { index: "05", name: "蚵仔煎", price: 4 },
    { index: "06", name: "臭豆腐", price: 4 },
    { index: "07", name: "雞排", price: 6 },
    { index: "08", name: "珍珠奶茶", price: 4 },
    { index: "09", name: "刨冰", price: 4 },
    { index: "10", name: "鳳梨酥", price: 4 },
  ];
